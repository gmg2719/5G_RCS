...
public class ImagePreviewActivity extends AppCompatActivity implements Handler.Callback, View.OnClickListener {
    ...
    private ImageView img_morefunction;
...
//        setStatusBar();
        ...
        img_morefunction = findViewById(R.id.img_more);
        ...
        img_morefunction.setOnClickListener(this);
    ...
    protected void setStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//5.0及以上
            ...
            if (useThemestatusBarColor) {
                getWindow().setStatusBarColor(Color.parseColor("#000000")/*getResources().getColor(R.color.action_bar_background_color)*/);
            } else {
...
//                        progressParentLayout.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.img_download) {// 检查权限
            ...
            showBottomPop(rootView.getRootView().getRootView(), currentItemOriginPathUrl);
        } else if(i == R.id.img_qrcode){
            loadOriginImage(currentItemOriginPathUrl);
        }
    }
     ...
     * 从底部弹出popupwindow
     */
    private void showBottomPop(View parent, String imageUrl) {
        final View popView = View.inflate(this, R.layout.big_imageview_popup_menu, null);
...
//        clickPopItem(popView, mPopWindow);//条目的点击
        ...
        ((TextView)popView.findViewById(R.id.send_to_friend)).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                mPopWindow.dismiss();
                final Intent shareIntent = new Intent();
                shareIntent.setAction(Intent.ACTION_SEND);
                shareIntent.putExtra(Intent.EXTRA_TEXT, currentItemOriginPathUrl);
                shareIntent.setType("text/plain");
                final CharSequence title = "分享";//getResources().getText(R.string.action_share);
                startActivity(Intent.createChooser(shareIntent, title));
            }
        });
        ((TextView)popView.findViewById(R.id.save_image)).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                mPopWindow.dismiss();
                DownloadPictureUtil.downloadPicture(context.getApplicationContext(), currentItemOriginPathUrl);
        ...
        ((TextView)popView.findViewById(R.id.recognize_qrcode)).setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                mPopWindow.dismiss();
                loadOriginImage(currentItemOriginPathUrl);
