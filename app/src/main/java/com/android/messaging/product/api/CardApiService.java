...
public interface CardApiService {
    ...
    //获取新闻封面
    @GET
    Observable<JsonElement> getCardCover(@Url String url);

    @GET
    Call<JsonElement> getCardCoverSync(@Url String url);
    ...
    Observable<NewsResponse> getCardList(@Query("category") String category);

    /**
     * 获取新闻详情
     */
    @GET
    Observable<ResultResponse<NewsDetail>> getCardDetail(@Url String url);
    ...
    @GET("{id}")
    Observable<H5CardApi> getH5Card(@Path("id") String path);
