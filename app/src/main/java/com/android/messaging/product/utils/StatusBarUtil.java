...
public class StatusBarUtil {
    ...
    public static void setStatusBarColor(Activity activity, int statusColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setStatusBarColorBelowKK(activity, statusColor);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            setStatusBarColorFromKK(activity, statusColor);
        }
    }

    static void setStatusBarColorBelowKK(Activity activity, int statusColor) {
    ...
    static void setStatusBarColorFromKK(Activity activity, int statusColor) {
        Window window = activity.getWindow();
        //设置Window为全透明
