...
//                            mConversationId);
    ...
    public String getNormalizedName(){
        return mConversationMetadata.getOtherParticipantNormalizedDestination();
    }
    //add by junwang for get chatbot name
    public String getChatbotName(){
        return mConversationMetadata.getmChatbotName();
    }
    ...
    //add by junwang
//    public void UpdateH5MsgStatus(final BindingBase<ConversationData> binding){
//        Assert.isTrue(binding.getData() == this);
//
//    }
