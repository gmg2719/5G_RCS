...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static class ConversationColumns implements BaseColumns {
        ...
        //add by junwang
        public static final String IS_H5_MESSAGE = "IS_H5_MESSAGE";
    }

    //add by junwang start
    private static final String CREATE_H5WL_TABLE_SQL = "CREATE TABLE " + H5WHITELIST_TABLE +" ("
            + "_id INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "
            + H5CodeNumberColumns.H5_DISPLAY_CODENUMBER + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_BUSINESS_NAME + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_BUSINESS_LOGO + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_TRIGGER_CODE + " INT DEFAULT(0), "
            + H5CodeNumberColumns.H5_MATCHER + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_RESPONSE_URL + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_BUSINESS_MENU_JSON + " TEXT DEFAULT(NULL), "

            + H5CodeNumberColumns.H5_PORT_NUMBER + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_CARD_MSG_TEMPLATE_NO + " INT DEFAULT(0), "
            + H5CodeNumberColumns.H5_CARD_TITLE + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_REGULAR_EXPRESSION + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_ACTION_BUTTON + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_CARD_TEMPLATE + " TEXT DEFAULT(NULL), "
            + H5CodeNumberColumns.H5_VERSION + " TEXT DEFAULT(NULL)"
            + ")";

    private static final String CREATE_CHATBOT_INFO_TABLE_SQL = "CREATE TABLE " + CHATBOT_INFO_TABLE +" ("
            + "_id INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "
            + ChatbotInfoColumns.CHATBOT_DOMAIN + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_SIP_URI + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_EXPIRY_TIME + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_ETAG + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_JSON + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_NAME + " TEXT DEFAULT(NULL), "
            + ChatbotInfoColumns.CHATBOT_SMS + " TEXT DEFAULT(NULL), "
    ...
    private static final String CREATE_CUSTOMERS_TABLE_SQL = "CREATE TABLE " + CUSTOMERS_TABLE +" ("
            + "_id INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "
            + CustomerColumns.CODE_NUMBER + " TEXT DEFAULT(NULL), "
            + CustomerColumns.BUSINESS_NAME + " TEXT DEFAULT(NULL), "
            + CustomerColumns.LOGO_PATH + " TEXT DEFAULT(NULL)"
            + ")";
    ...
    private static final String CREATE_CONVERSATIONS_TABLE_SQL =
            "CREATE TABLE " + CONVERSATIONS_TABLE + "("
                    ...
                    //add by junwang
                    + ConversationColumns.IS_H5_MESSAGE + " INT DEFAULT(0)"
                    + ");";
    ...
    public static class MessageColumns implements BaseColumns {
        ...
        public static final String CHATBOT_SUBSCRIBE_STATUS = "chatbot_subscribe_status";

        public static final String CHATBOT_VOTE_STATUS = "chatbot_vote_status";

        public static final String CHATBOT_VOTED_ITEM_POSITION = "chatbot_voted_item_position";

        public static final String CHATBOT_RCSDB_MSGID = "chatbot_rcsdb_msgid";

        public static final String CHATBOT_CARD_INVALID = "chatbot_card_invalid";

        public static final String CHATBOT_CARD_INVALID_PROMPT = "chatbot_card_invalid_prompt";
    ...
    private static final String CREATE_MESSAGES_TABLE_SQL =
            "CREATE TABLE " + MESSAGES_TABLE + " ("
                    ...
                    //add by junwang for chatbot subscribe activity card type and vote card type
                    + MessageColumns.CHATBOT_SUBSCRIBE_STATUS + " INT DEFAULT(0), "
                    + MessageColumns.CHATBOT_VOTE_STATUS + " INT DEFAULT(0), "
                    + MessageColumns.CHATBOT_VOTED_ITEM_POSITION + " INT DEFAULT(0), "
                    + MessageColumns.CHATBOT_RCSDB_MSGID + " TEXT DEFAULT(NULL), "
                    + MessageColumns.CHATBOT_CARD_INVALID + " INT DEFAULT(0), "
                    + MessageColumns.CHATBOT_CARD_INVALID_PROMPT + " TEXT DEFAULT(NULL), "
    ...
    private static final String CREATE_PARTS_TABLE_SQL =
            "CREATE TABLE " + PARTS_TABLE + "("
                    ...
                    + MessagingContentProvider.UNSPECIFIED_SIZE + "),"
                    //add by junwang start
                    + PartColumns.JSON_STRING + " TEXT DEFAULT(NULL),"
                    //add by junwang end
    ...
    public static class H5CodeNumberColumns implements BaseColumns{
        ...
        public static final String H5_BUSINESS_NAME = "busn_name";
        public static final String H5_BUSINESS_LOGO = "busn_logo";
        public static final String H5_TRIGGER_CODE = "trigger_code";
        public static final String H5_MATCHER = "matcher";
        public static final String H5_RESPONSE_URL = "response_url";
        public static final String H5_BUSINESS_MENU_JSON = "menu_json";

        public static final String H5_PORT_NUMBER = "port_number";
        public static final String H5_CARD_MSG_TEMPLATE_NO = "card_msg_template_no";
        public static final String H5_CARD_TITLE = "card_msg_title";
        public static final String H5_REGULAR_EXPRESSION = "regular_expression";
        public static final String H5_ACTION_BUTTON = "action_button";
        public static final String H5_CARD_TEMPLATE = "card_template";
        public static final String H5_VERSION = "version";
    }

    public static class ChatbotInfoColumns implements BaseColumns{
        public static final String CHATBOT_DOMAIN = "domain";
        public static final String CHATBOT_SIP_URI = "chatbot_sip_uri";
        public static final String CHATBOT_EXPIRY_TIME = "expiry_time";
        public static final String CHATBOT_ETAG = "chatbot_etag";
        public static final String CHATBOT_JSON = "chatbot_json";
        public static final String CHATBOT_NAME = "chatbot_name";
        public static final String CHATBOT_SMS = "chatbot_sms";
        public static final String CHATBOT_MENU = "chatbot_menu";
    }

    public static class ChatbotFavoriteColumns implements BaseColumns{
        public static final String CHATBOT_FAV_SIP_URI = "chatbot_fav_sip_uri";
        public static final String CHATBOT_FAV_NAME = "chatbot_fav_name";
        public static final String CHATBOT_FAV_LOGO = "chatbot_fav_logo";
        public static final String CHATBOT_FAV_CARD_DESCRIPTION = "chatbot_fav_card_description";
        public static final String CHATBOT_FAV_IMAGE_URL = "chatbot_fav_image_url";
    ...
    static final String DRAFT_PARTS_VIEW_SQL = "CREATE VIEW " +
            ...
            //add by junwang start
            + PARTS_TABLE + '.' + PartColumns.JSON_STRING
            + " as " + PartColumns.JSON_STRING + ", "
            //add by junwang end
    ...
    private static final String[] CREATE_VIEW_SQLS = new String[] {
        ...
        //add by junwang
        //ConversationListItemData.getConversationH5ListViewSql(),
    ...
    private static void createDatabase(final SQLiteDatabase db) {
        for (final String sql : CREATE_TABLE_SQLS) {
            LogUtil.i("junwang", "create all tables");
            db.execSQL(sql);
        }
