...
//            if(!isOutgoing){
//                if(sender != null){
//                    String normaledDestination = sender.getNormalizedDestination();
//                    if(normaledDestination != null/* && normaledDestination.startsWith("106")*/) {
//                        LogUtil.i("Junwang", "storeSms " + "sender.NormaledDestination = " + normaledDestination);
//                        final Context context = Factory.get().getApplicationContext();
//                        Intent intent = new Intent(context, BusinessCardService.class);
//                        intent.putExtra(DatabaseHelper.H5CodeNumberColumns.H5_DISPLAY_CODENUMBER, normaledDestination);
