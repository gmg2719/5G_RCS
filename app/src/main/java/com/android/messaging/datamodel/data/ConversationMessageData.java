...
public class ConversationMessageData {
    ...
    public void bind(final Cursor cursor) {
        ...
        //add by junwang for chatbot subscribe activity card type and vote card type
        mChatbotSubscribeStatus = (cursor.getInt(INDEX_CHATBOT_SUBSCRIBE_STATUS) != 0);
        mChatbotVoteStatus = (cursor.getInt(INDEX_CHATBOT_VOTE_STATUS) != 0);
        mChatbotVotedItemPosition = cursor.getInt(INDEX_CHATBOT_VOTED_ITEM_POSITION);
        mChatbotRcsdbMsgId = cursor.getString(INDEX_CHATBOT_RCSDB_MSGID);
        mChatbotCardInvalid = (cursor.getInt(INDEX_CHATBOT_CARD_INVALID) != 0);
        mChatbotCardInvalidPrompt = cursor.getString(INDEX_CHATBOT_CARD_INVALID_PROMPT);
        ...
        //add by junwang
        mJson = cursor.getString(INDEX_SMS_JSON);
    ...
    public boolean getIsChatbotSubscribed() {
        return mChatbotSubscribeStatus;
    }

    public boolean getIsChatbotVoted() {
        return mChatbotVoteStatus;
    }

        public int getChatbotVotedItemPosition() {
        return mChatbotVotedItemPosition;
    }

    public String getmChatbotRcsdbMsgId() {
    ...
    private static final String CONVERSATION_MESSAGES_QUERY_PROJECTION_SQL =
            ...
            + makeCaseWhenString(PartColumns.JSON_STRING, true,
            ConversationMessageViewColumns.JSONSTRING) + ", "
            //add by junwang end
            ...
            //add by junwang for chatbot subscribe activity card type and vote card type
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_SUBSCRIBE_STATUS
            + " as " + ConversationMessageViewColumns.CHATBOT_SUBSCRIBE_STATUS + ", "
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_VOTE_STATUS
            + " as " + ConversationMessageViewColumns.CHATBOT_VOTE_STATUS + ", "
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_VOTED_ITEM_POSITION
            + " as " + ConversationMessageViewColumns.CHATBOT_VOTED_ITEM_POSITION + ", "
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_RCSDB_MSGID
            + " as " + ConversationMessageViewColumns.CHATBOT_RCSDB_MSGID + ", "
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_CARD_INVALID
            + " as " + ConversationMessageViewColumns.CHATBOT_CARD_INVALID + ", "
            + DatabaseHelper.MESSAGES_TABLE + '.' + MessageColumns.CHATBOT_CARD_INVALID_PROMPT
            + " as " + ConversationMessageViewColumns.CHATBOT_CARD_INVALID_PROMPT + ", "
...
//            + " as " + ConversationMessageViewColumns.JSONSTRING + ", "
    ...
    interface ConversationMessageViewColumns extends BaseColumns {
        ...
        //add by junwang
        static final String CHATBOT_SUBSCRIBE_STATUS = MessageColumns.CHATBOT_SUBSCRIBE_STATUS;
        static final String CHATBOT_VOTE_STATUS = MessageColumns.CHATBOT_VOTE_STATUS;
        static final String CHATBOT_VOTED_ITEM_POSITION = MessageColumns.CHATBOT_VOTED_ITEM_POSITION;
        static final String CHATBOT_RCSDB_MSGID = MessageColumns.CHATBOT_RCSDB_MSGID;
        static final String CHATBOT_CARD_INVALID = MessageColumns.CHATBOT_CARD_INVALID;
        static final String CHATBOT_CARD_INVALID_PROMPT = MessageColumns.CHATBOT_CARD_INVALID_PROMPT;
        ...
        //add by junwang
        static final String JSONSTRING = MessageColumns.JSON;
    }
    ...
    //add by junwang
    private static final int INDEX_SMS_JSON                      = sIndexIncrementer++;
    ...
    private static String[] sProjection = {
        ...
        //add by junwang for chatbot subscribe activity card type and vote card type
        ConversationMessageViewColumns.CHATBOT_SUBSCRIBE_STATUS,
        ConversationMessageViewColumns.CHATBOT_VOTE_STATUS,
        ConversationMessageViewColumns.CHATBOT_VOTED_ITEM_POSITION,
        ConversationMessageViewColumns.CHATBOT_RCSDB_MSGID,
        ConversationMessageViewColumns.CHATBOT_CARD_INVALID,
