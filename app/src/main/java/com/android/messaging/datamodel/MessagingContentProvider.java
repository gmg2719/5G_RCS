...
//                    if(selectionArgs[0].equals(ConversationListFragment.BUNDLE_NORMAL_MESSAGE_MODE)){
//                        queryBuilder.setTables(ConversationListItemData.getConversationListView());
//                    }else if(selectionArgs[0].equals(ConversationListFragment.BUNDLE_H5_MESSAGE_MODE)){
//                        queryBuilder.setTables(ConversationListItemData.getConversationH5ListView());
//                    }else{
//                        queryBuilder.setTables(ConversationListItemData.getConversationListView());
//                        LogUtil.d("Junwang", "CONVERSATIONS_QUERY_CODE selectionArgs error");
//                    }
//                    queryArgs = null;
//                }
//                else{
