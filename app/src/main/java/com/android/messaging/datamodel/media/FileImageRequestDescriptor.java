...
public class FileImageRequestDescriptor extends UriImageRequestDescriptor {
    ...
    public FileImageRequestDescriptor(final String path, final int desiredWidth,
        ...
        super(UriUtil.getUriForResourceFile(path), desiredWidth, desiredHeight, cropToCircle,
                ImageUtils.DEFAULT_CIRCLE_BACKGROUND_COLOR, ImageUtils.DEFAULT_CIRCLE_STROKE_COLOR);
        this.path = path;
        this.canUseThumbnail = true;
    }
