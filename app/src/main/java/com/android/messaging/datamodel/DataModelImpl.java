...
public class DataModelImpl extends DataModel {
    ...
    @Override
    public ConversationListData createConversationListData(final Context context,
            final ConversationListDataListener listener, final boolean archivedMode, final String normalmode) {
        return new ConversationListData(context, listener, archivedMode, normalmode);
    }
