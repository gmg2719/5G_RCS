...
public class ConversationListData extends BindableData
    ...
    //add by junwang
    private static final String WHERE_NORMAL_MSG =
            "(" + ConversationListViewColumns.IS_H5_MESSAGE + " = 0)";
    private static final String WHERE_H5_MSG =
            "(" + ConversationListViewColumns.IS_H5_MESSAGE + " = 1)";
    ...
    //add by junwang
    private  String mNormalMode = null;
    ...
    //add by junwang
    public ConversationListData(final Context context, final ConversationListDataListener listener,
             final boolean archivedMode, final String normalmode) {
        mListener = listener;
        mContext = context;
        mArchivedMode = archivedMode;
    ...
    //add by junwang
    private static final int NORMAL_CONVERSATION_LIST_LOADER = 3;
    private static final int H5_CONVERSATION_LIST_LOADER = 4;
...
//                            //modified by junwang
//                            mNormalMode == null ? null : new String[]{mNormalMode},
////                            null,       // selection args
//                            SORT_ORDER);
                        //modified by junwang
                    loader = new BoundCursorLoader(bindingId, mContext,
                            MessagingContentProvider.CONVERSATIONS_URI,
                            ConversationListItemData.PROJECTION,
                            mArchivedMode ? WHERE_ARCHIVED : WHERE_NOT_ARCHIVED + " AND "
                            + (ConversationListFragment.BUNDLE_H5_MESSAGE_MODE.equals(mNormalMode) ? WHERE_H5_MSG : WHERE_NORMAL_MSG),
                            //modified by junwang
//                            mNormalMode == null ? null : new String[]{mNormalMode},
                            null,       // selection args
                            SORT_ORDER);
                    break;
                //add by junwang
                case NORMAL_CONVERSATION_LIST_LOADER:
                    break;
                case H5_CONVERSATION_LIST_LOADER:
                    break;
                default:
    ...
    public void init(final LoaderManager loaderManager,
        ...
        //add by junwang
//        mLoaderManager.initLoader(NORMAL_CONVERSATION_LIST_LOADER, mArgs, this);
//        mLoaderManager.initLoader(H5_CONVERSATION_LIST_LOADER, mArgs, this);
    }
