...
public class MarkAsReadAction extends Action implements Parcelable {
     ...
     */
    public static void markAsRead(final String conversationId, final String rcsDBMsgId) {
        final MarkAsReadAction action = new MarkAsReadAction(conversationId, rcsDBMsgId);
        action.start();
    }

    private MarkAsReadAction(final String conversationId, final String rcsDBMsgId) {
    ...
    protected Object executeAction() {
        ...
        if(rcsDBMsgId != null){
//            RcsMessageService.markMessageAsRead(rcsDBMsgId);
        }
        return null;
    }
