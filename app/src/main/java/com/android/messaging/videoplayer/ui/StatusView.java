package com.android.messaging.videoplayer.ui;
...
public class StatusView extends LinearLayout {
    ...
    public void showNetWarning(ViewGroup container, int index) {
        ...
        setButtonTextAndAction(getResources().getString(R.string.dkplayer_continue_play), new View.OnClickListener() {
            @Override
    ...
    public void showErrorView(ViewGroup container, int index) {
        ...
        setButtonTextAndAction(getResources().getString(R.string.dkplayer_retry), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
    ...
    private void setButtonTextAndAction(String text, View.OnClickListener listener) {
        if (btnAction != null) {
