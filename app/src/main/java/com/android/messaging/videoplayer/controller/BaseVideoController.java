package com.android.messaging.videoplayer.controller;
...
import com.android.messaging.videoplayer.player.VideoViewManager;
...
public abstract class BaseVideoController<T extends MediaPlayerControl> extends FrameLayout
        implements com.android.messaging.videoplayer.controller.OrientationHelper.OnOrientationChangeListener {
    ...
    protected com.android.messaging.videoplayer.controller.OrientationHelper mOrientationHelper;
    ...
    protected void initView() {
        ...
        setClickable(true);
        setFocusable(true);
        mOrientationHelper = new com.android.messaging.videoplayer.controller.OrientationHelper(getContext().getApplicationContext());
