...
import com.android.messaging.util.PlayerUtils;
import com.android.messaging.videoplayer.controller.BaseVideoController;
import com.android.messaging.videoplayer.controller.MediaPlayerControl;
import com.android.messaging.videoplayer.listener.OnVideoViewStateChangeListener;
import com.android.messaging.videoplayer.listener.PlayerEventListener;
import com.android.messaging.videoplayer.render.IRenderView;
import com.android.messaging.videoplayer.render.SurfaceRenderView;
import com.android.messaging.videoplayer.render.TextureRenderView;
import com.android.messaging.videoplayer.util.L;
...
//            | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;
    ...
    public DanmuVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        //读取全局配置
        com.android.messaging.videoplayer.player.VideoViewConfig config = com.android.messaging.videoplayer.player.VideoViewManager.getConfig();
