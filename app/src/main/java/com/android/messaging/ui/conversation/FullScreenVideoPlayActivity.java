...
public class FullScreenVideoPlayActivity extends Activity implements View.OnTouchListener, VideoListener {
...
//        }
        setContentView(R.layout.full_videoview_activity);
