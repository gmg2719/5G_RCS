...
//                    hasCustomTransitions);
            UIIntents.get().launchConversationWithH5InfoActivity(
                    this, conversationId, null,
                    sceneTransitionAnimationOptions,
                    hasCustomTransitions, conversationListItemData.getH5TriggerCode(),
                    conversationListItemData.getH5Matcher(), conversationListItemData.getH5ResponseUrl(),
                    conversationListItemData.getH5MenuJson(), conversationListItemData.getPortNumber(),
                    conversationListItemData.getCardMsgTemplateNo(), conversationListItemData.getCardMsgTitle(),
                    conversationListItemData.getRegularExpression(), conversationListItemData.getActionButton(),
                    conversationListItemData.getCardTemplate(), conversationListItemData.getmChatbotMenu());
        }
    }
