...
public class PowerVideoView extends FrameLayout {
    ...
    public PowerVideoView(@NonNull Context context) {
        this(context, null);
    }

    public PowerVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PowerVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
