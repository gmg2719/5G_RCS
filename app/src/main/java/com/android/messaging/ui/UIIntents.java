...
public abstract class UIIntents {
    ...
    //add by junwang
    public abstract void launchConversationWithH5InfoActivity(final Context context,
                                                    final String conversationId, final MessageData draft, final Bundle activityOptions,
                                                    final boolean withCustomTransition, int triggerCode, String matcher, String responseUrl, String menuJson,
