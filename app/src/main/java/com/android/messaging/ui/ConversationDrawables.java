...
public class ConversationDrawables {
    ...
    public void updateDrawables() {
        ...
        mIncomingBubbleDrawable = resources.getDrawable(/*R.drawable.msg_bubble_incoming*/R.drawable.message_incoming_bubble_border_textview);
        ...
        mOutgoingBubbleDrawable =  resources.getDrawable(/*R.drawable.msg_bubble_outgoing*/R.drawable.message_outgoing_bubble_border_textview);
...
//                color = mThemeColor;
                final Resources resources = mContext.getResources();
                color = resources.getColor(R.color.message_backgroud_color_incoming);
            }
        } else {
