...
import com.android.messaging.ui.santipopupmenu.OptionMenu;
import com.android.messaging.ui.santipopupmenu.OptionMenuView;
import com.android.messaging.ui.santipopupmenu.PopLayout;
    ...
    protected void onFinishInflate() {
        ...
        mComposeEditText.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(final View v, final boolean hasFocus) {
                LogUtil.i("Junwang", "mComposeEditText onFocusChange");
        ...
        mComposeEditText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                LogUtil.i("Junwang", "mComposeEditText onClick");
                //add by junwang
//                arg0.requestFocus();
//                mHost.onComposeEditTextFocused();
//                ConversationMessageView.getActivityFromView(arg0).getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
    ...
    //add by junwang
    public ConversationInputManager getInputManager(){
