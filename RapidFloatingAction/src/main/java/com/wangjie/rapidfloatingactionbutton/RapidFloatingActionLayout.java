...
public class RapidFloatingActionLayout extends RelativeLayout implements OnClickListener {
    ...
    public static final long EXPAND_ANIMATION_DURATION = 150;
    public static final long COLLAPSE_ANIMATION_DURATION = 10;
...
//            throw new RuntimeException("contentView: [" + this.contentView + "] is already initialed");
    ...
    public void collapseContent() {
        ...
        animatorSet.setDuration(/*ANIMATION_DURATION*/COLLAPSE_ANIMATION_DURATION);
        animatorSet.setInterpolator(mAccelerateInterpolator);
    ...
    private void endAnimatorSet() {
        Log.i("Junwang", "toggle animation end");
        if (null != animatorSet) {
            animatorSet.end();
        }
    }
